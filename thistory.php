...
<tr style="color : black;">
            <td class="py-2 trans"><?php echo $rows['sno']; ?></td>
            <td class="py-2 trans"><?php echo $rows['sender']; ?></td>
            <td class="py-2 trans"><?php echo $rows['receiver']; ?></td>
            <td class="py-2 trans"><?php echo $rows['balance']; ?> </td>
            <td class="py-2 trans"><?php echo $rows['datetime']; ?> </td>
